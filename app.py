...
def dados_desordenados():
    if request.method == "POST":
        if request.form.get("dado"):
            ...
            print("mostrar_modal:", "desordenado")
            print("dadosDesordenados:", dadosDesordenados)
    return render_template("index.html", mostrar_modal="desordenado", dadosDesordenados=dadosDesordenados, FequenciaIndividualAbsoluta={},FrequenciaAcumulada={}, Posicoes={}, FequenciaIndividualAbsolutaRecebida = {})
...
def dados_em_tabela():
    ...
    return render_template("index.html", mostrar_modal="tabela", FequenciaIndividualAbsolutaRecebida = FequenciaIndividualAbsolutaRecebida, FequenciaIndividualAbsoluta={},FrequenciaAcumulada={}, Posicoes={})
...
def calculo_dos_dados():
    ...
    return render_template("index.html", media=media, moda=moda, tipo_moda = tipo_moda, mediana=mediana_calculada,  dadosDesordenados=dadosDesordenados, FequenciaIndividualAbsoluta=FequenciaIndividualAbsoluta, tamanhoDaAmostra=tamanhoDaAmostra, FrequenciaAcumulada=FrequenciaAcumulada, Posicoes=Posicoes, FequenciaIndividualAbsolutaRecebida = {}, mostrar_modal = modal_aberto, tipo = tipo)
